...
namespace CEMSApp.Parameter
{
    ...
    /// 5.修改“删除按钮”回传刷新代码
    /// </summary>
    public partial class FaultLevelForm : ChildForm
    {
        ILog log = log4net.LogManager.GetLogger(typeof(FaultLevelForm));
        //DataSet ds_report = null;
        public FaultLevelForm()
        {
            InitializeComponent();
        }
        //窗体初始化
        private void AccountForm_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = acc.queryInfomation("fault_level");
            BindSourceGrid(grid1, ds.Tables[0],"故障模式");
        ...
        {
            FaultLevelAddForm addForm = new FaultLevelAddForm();
        ...
        private void editButton_Click(object sender, EventArgs e)
        {
            ...
            FaultLevelEditForm editForm = new FaultLevelEditForm(id);
            try
            {
        ...
        private void delButton_Click(object sender, EventArgs e)
        {
            ...
            if (grid1[grid1.Selection.ActivePosition.Row, 0] != null)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    flag = acc.deleteInfomation(grid1[grid1.Selection.ActivePosition.Row, 0].ToString(), "fault_level");
                    if (flag)
                    {
