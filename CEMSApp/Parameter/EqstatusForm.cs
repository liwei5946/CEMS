...
namespace CEMSApp.Parameter
{
    ...
    /// 5.修改“删除按钮”回传刷新代码
    /// </summary>
    public partial class EqstatusForm : ChildForm
    {
        ILog log = log4net.LogManager.GetLogger(typeof(EqstatusForm));
        ...
        private void editButton_Click(object sender, EventArgs e)
        {
            ...
            EqstatusEditForm editForm = new EqstatusEditForm(id);
            try
            {
        ...
        private void delButton_Click(object sender, EventArgs e)
        {
            ...
            if (grid1[grid1.Selection.ActivePosition.Row, 0] != null)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    flag = acc.deleteInfomation(grid1[grid1.Selection.ActivePosition.Row, 0].ToString(), "eq_status");
                    if (flag)
                    {
