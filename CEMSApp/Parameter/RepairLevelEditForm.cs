...
{
    public partial class RepairLevelEditForm : ChildForm
    {
        ILog log = log4net.LogManager.GetLogger(typeof(RepairLevelEditForm));
        string globleId = "";
        public RepairLevelEditForm(string id)
        {
            InitializeComponent();
            globleId = id;
        }
