...
{
    public partial class TroubleEditForm : ChildForm
    {
        ILog log = log4net.LogManager.GetLogger(typeof(TroubleEditForm));
        string globalTroubleId="";
        byte[] img = new byte[] { 0 };
        ...
        private void ok_Click(object sender, EventArgs e)
        {
            ...
            flag = aa.updateTrouble(dateTime_troubletime.Text, richText_process.Text, richText_reason.Text, richText_lose.Text, richText_todo.Text, img, globalTroubleId);
