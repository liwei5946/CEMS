...
{
    public partial class PartEditForm : ChildForm
    {
        ILog log = log4net.LogManager.GetLogger(typeof(PartEditForm));
        ...
        public PartEditForm(string partId, string eqname)
        {
            InitializeComponent();
            globleId = partId;
        ...
        private void ok_Click(object sender, EventArgs e)
        {
            ...
            flag = aa.updatePart(text_partasset.Text, text_partname.Text, text_partmaterial.Text, text_partweight.Text, globleStandard, img, threeD, globleId);
